...
it to join. If you don't see the invitation, accept it `here <https://github.com/coala>`__.
...
Click the link `here <https://coala.io/new>`_ to see all Newcomer issues.
...
`here <http://api.coala.io/en/latest/Developers/Newcomers_Guide.html#step-4-creating-a-fork-and-testing-your-changes>`__ (in step 4, above).
